                    ...
                    try (ResultSet rs = stm.executeQuery()){
                        if (rs.next()) {
                           ...
                           textoCodigo.setEnabled(false);
                            ...
                            JOptionPane.showMessageDialog(null, 
                                    "No se ha encontrado ningun proveedor asociado a ese código", 
                                    "Error", 
                                    JOptionPane.ERROR_MESSAGE, imagenPerso(false));
                            textoCodigo.requestFocus();
                        }
    ...
    private void botonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAceptarActionPerformed
        ...
        switch (modo) {
            case ALTA:
                ...
                JOptionPane.showMessageDialog(null, 
                        "Todos los campos estan bien, proveedor agregado a la base de datos", 
                        "¡Enhorabuena!",
            ...
            case MODIFICACIONES:
                ...
                String update = "UPDATE proveedores SET nif = ?,"
                        + "apellidos = ?, "
                        + "nombre = ?, "
                        + "domicilio = ?, "
                        + "codigo_postal = ?, "
                ...
                try (Connection conexion = conn.connect();
                    ...
                    if (filas == 1) {
                        ...
                        JOptionPane.showMessageDialog(
                            this,
                            "No se ha podido modificar el proveedor",
                            "ERROR",
                            JOptionPane.ERROR_MESSAGE,imagenPerso(false)
                        );
                    }
